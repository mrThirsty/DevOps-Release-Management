...
{
    public class AuditItemDataService : BaseLoggableDataService<AuditItem>, IAuditItemDataService
    {
        public AuditItemDataService(ReleaseDataContext context, IRMLogger logger) : base(context, logger)
        {
        }
